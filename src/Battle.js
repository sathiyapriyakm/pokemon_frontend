...
export default function Battle() {
  ...
  console.log("battle at start is", battleId);
  ...
  return (
    <div className="battle">
      ...
      {(battle.playerOne.pokemon.hp <= 0 ||
        battle.playerTwo.pokemon.hp <= 0) && <VictoryStage battle={battle} />}
      {/* </>: <h2>Loading....</h2>} */}
    </div>
  );
}
      ...
      <div className="displayOption_battle">
        <div className="options">
          ...
          <img
            ...
            className="pokeimg"
            alt={battle.playerOne.pokemon.name}
          ></img>
